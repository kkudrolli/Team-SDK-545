...
CONFIG.CLKOUT4_DRIVES {BUFG} CONFIG.CLKOUT4_JITTER {655.009} \
CONFIG.CLKOUT4_PHASE_ERROR {699.797} CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {40} \
...
CONFIG.MMCM_CLKOUT2_DIVIDE {41} CONFIG.MMCM_CLKOUT3_DIVIDE {15} \
