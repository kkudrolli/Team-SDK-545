...
CONFIG.CLKOUT4_DRIVES {BUFG} CONFIG.CLKOUT4_JITTER {574.330} \
CONFIG.CLKOUT4_PHASE_ERROR {699.797} CONFIG.CLKOUT4_USED {true} \
CONFIG.CLKOUT5_DRIVES {BUFG} CONFIG.CLKOUT6_DRIVES {BUFG} \
CONFIG.CLKOUT7_DRIVES {BUFG} CONFIG.MMCM_CLKFBOUT_MULT_F {54.125} \
CONFIG.MMCM_CLKIN1_PERIOD {5.0} CONFIG.MMCM_CLKOUT0_DIVIDE_F {22.250} \
CONFIG.MMCM_CLKOUT1_DIVIDE {120} CONFIG.MMCM_CLKOUT2_DIVIDE {41} \
CONFIG.MMCM_CLKOUT3_DIVIDE {6} CONFIG.MMCM_COMPENSATION {ZHOLD} \
CONFIG.MMCM_DIVCLK_DIVIDE {18} CONFIG.NUM_OUT_CLKS {4} \
CONFIG.PRIMITIVE {MMCM} CONFIG.PRIM_IN_FREQ {200.000} \
CONFIG.USE_LOCKED {false}  ] $clk_wiz_0
