...
CONFIG.CLKOUT3_JITTER {158.322} CONFIG.CLKOUT3_PHASE_ERROR {103.084} \
CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {14.7456} CONFIG.CLKOUT3_USED {true} \
CONFIG.CLKOUT4_DRIVES {BUFG} CONFIG.CLKOUT4_JITTER {142.693} \
CONFIG.CLKOUT4_PHASE_ERROR {103.084} CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {25} \
...
CONFIG.MMCM_CLKOUT2_DIVIDE {42} CONFIG.MMCM_CLKOUT3_DIVIDE {25} \
