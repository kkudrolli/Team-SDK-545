...
CONFIG.Coe_File {../../../../../../320.coe} CONFIG.Enable_32bit_Address {false} \
...
CONFIG.Read_Width_A {320} CONFIG.Read_Width_B {320} \
...
CONFIG.Write_Depth_A {128} CONFIG.Write_Width_A {320} \
CONFIG.Write_Width_B {320} CONFIG.use_bram_block {Stand_Alone} \
 ] $blk_mem_gen_0
