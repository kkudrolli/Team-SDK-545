...
################################################################
# This is a generated script based on design: weights_1
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.Byte_Size {9} CONFIG.Coe_File {../../../../../../320.coe} CONFIG.Enable_32bit_Address {false} CONFIG.Enable_A {Always_Enabled} CONFIG.Fill_Remaining_Memory_Locations {true} CONFIG.Load_Init_File {true} CONFIG.Operating_Mode_A {NO_CHANGE} CONFIG.Read_Width_A {320} CONFIG.Read_Width_B {320} CONFIG.Register_PortA_Output_of_Memory_Primitives {false} CONFIG.Use_Byte_Write_Enable {false} CONFIG.Use_RSTA_Pin {false} CONFIG.Write_Depth_A {128} CONFIG.Write_Width_A {320} CONFIG.Write_Width_B {320} CONFIG.use_bram_block {Stand_Alone}  ] $blk_mem_gen_0
